...
# Anual
como el $%$ de datos faltantes es menor al 1% de los datos disponibles los eliminaremos para mayor facilidad de trabajo. AdemÃ¡s pasrameos la variable 
...
## Calor de cierre en bolsa del bitcoin entre un periodo en noviembre del 2021
